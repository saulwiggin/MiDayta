...
class Rawdata extends CI_Controller {
	...
	// 			} else {
	// 			// echo 'ALARM2'.$name. ' is on'; 
	// 			}
	// 		} else {
	// 		//echo 'ALARM2'.$name. ' is not analogue'; 
	// 		}
	// 		//reset 3
	// 		if ($inputs[$i-1]['type'] == 'analogue'){ 
	...
	// 					}
	// 				} else { 
	// 				//echo $name. 'direction is 0'.'ALARM 3'; 
	// 				}
	// 			} else { 
	// 			//echo $name . ' is not on'.'ALARM 3';
	// 			}
	// 		} 
	// 		if ($inputs[$i-1]['type'] == 'analogue'){ 
	// 			if ($inputs[$i-1]['is_on3'] == 0){
	...
	// 					}
	// 				} else { 
	// 				//echo $name. 'direction is 0'.'ALARM 4'; 
	// 				}
	// 			} else { 
	// 			//echo $name . ' is not on'.'ALARM 4';
	// 		}
	// 		} 
	// 		if ($inputs[$i-1]['type'] == 'analogue'){ 
	// 			if ($inputs[$i-1]['is_on4'] == 0){
	...
	public function raw_data_for_user(){
		...
		//print_r(is_object($data['results']));
		//var_dump(array_values($data['results'][0]));
		$limit_data_to_20 = array_slice($data['results'],0,20);
...
// 	    $scaled_value = $last_message[$input_id]*$scaleby;
// 		//$message = $usermessage . "\r\n" . "\r\n" . 'This email was triggered at ' . date("Y-m-d H:i:s", $timestamp) . " (" . $poshname . " alarm " . $alarm_no . ")";
// 			$message =  $inputs[$input_id-1]['name'] . " Alarm " . $alarm_no . ' - ' . $inputs[$input_id-1]['label_name'] . " has reached its threshold at " 
